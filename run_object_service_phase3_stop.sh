...
if [[ -z "${CUDA_VISIBLE_DEVICES:-}" ]]; then echo "Set CUDA_VISIBLE_DEVICES first." >&2; exit 2; fi
exec /cvhci/temp/squan/qwen_object_service/.mamba_env/bin/python /cvhci/temp/squan/qwen_object_service/api_server_phase3_stop.py
